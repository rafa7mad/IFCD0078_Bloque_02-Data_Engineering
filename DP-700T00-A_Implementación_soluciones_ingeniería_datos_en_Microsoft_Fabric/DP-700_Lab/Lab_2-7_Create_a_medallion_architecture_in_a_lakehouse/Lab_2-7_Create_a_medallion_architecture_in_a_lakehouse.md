...
In the workspace you just created, create a new Lakehouse named Sales by selecting the + New item button. Leave the Lakehouse schemas checkbox selected.
...
[!NOTE] The SQL analytics endpoint uses T-SQL syntax. If you’re adapting queries from other SQL dialects, use TOP (10) instead of LIMIT 10.
...
code
![Screenshot of a semantic model in Fabric.](/mslearn-fabric/Instructions/Labs/Images/dataset-relationships.png)
...
[Inicio](#create-a-medallion-architecture-in-a-microsoft-fabric-lakehouse)
