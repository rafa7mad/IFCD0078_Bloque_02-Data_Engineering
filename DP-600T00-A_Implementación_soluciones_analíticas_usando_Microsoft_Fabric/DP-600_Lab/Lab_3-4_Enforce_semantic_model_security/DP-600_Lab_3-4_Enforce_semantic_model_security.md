...
>! **Note**: If a security warning asks you to apply changes, select **Ignore** or **Close**. Don’t select **Discard change**s. If prompted about a data source connection, dismiss the warning — you won’t need to refresh data in this lab.
...
![images](images)
Screenshot of the Model view icon selected in the Power BI Desktop navigation pane.
...
![images](images)
Screenshot of the model diagram showing six dimension tables and one fact table in a star schema.
...
![images](images)
Screenshot of the role creation dialog with the DAX editor option.
